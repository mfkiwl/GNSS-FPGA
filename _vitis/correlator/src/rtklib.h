...
extern int outrnxobsh(const rnxopt_t *opt, const nav_t *nav);
extern int outrnxobsb(const rnxopt_t *opt, const obsd_t *obs, int n,
                      int epflag);
extern int outrnxnavh (const rnxopt_t *opt, const nav_t *nav);
...
extern int outrnxnavb (const rnxopt_t *opt, const eph_t *eph);
extern int outrnxgnavb(const rnxopt_t *opt, const geph_t *geph);
